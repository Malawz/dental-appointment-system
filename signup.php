...
<div class="content"><!-- Registration handler content starts here -->
<p>
<?php
...
// Make the query:
$q = "INSERT INTO signup(user_level,name,phone,age,address,email,password,registration_date) VALUES(0,'$name','$phone','$age','$address','$email','$p',NOW() )";
