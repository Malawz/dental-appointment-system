...
<h2 class="page">Patients Information</h2>
...
$q = "SELECT name AS name,age AS age ,phone AS phone,email AS email,address AS address ,userid  FROM signup where user_level != 1 ";
